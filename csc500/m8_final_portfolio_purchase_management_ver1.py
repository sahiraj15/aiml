...
class ShoppingCart():
    def __init__(self, customer_name: str = 'none', shopping_date: str = 'none'):
        super().__init__()
...
if __name__ == "__main__":
    ...
    sc.add_item(item_name1, item_desc1, item_price1, item_quant1)
    sc.add_item(item_name2, item_desc2, item_price2, item_quant2)
    sc.print_item_wise_cost_summary()
    ...
    sc = ShoppingCart(user_name, cart_date)
        ...
        if item_flag == 'a':
            ...
            if not sc.item_line.keys():
                ...
                if item_name not in sc.item_line:
                    ...
                    description = input("Enter the new description(old: {}), N: NoChange: \n".format(sc.item_line[item_name]['description']))
                    price = input("Enter the new price(old: {}), N: NoChange: \n".format(sc.item_line[item_name]['price']))
                    quantity = input("Enter the new quantity(old: {}), N: NoChange: \n".format(sc.item_line[item_name]['quantity']))
